...
class TestTransponderServer(XlateTestCase):
    ...
    #         [data] = self.conn.get_operational("/goldstone-transponder:modules/module[name='piu1']/name")
    ...
    #         )
    #         self.conn.apply()
    #         data = self.conn.get_operational("/org-openroadm-device:org-openroadm-device/circuit-packs[circuit-pack-name='piu1']")
    ...
    #         data = self.conn.get(f"/goldstone-transponder:modules/module[name='{piu_val}']/network-interface[name='0']/config/output-power")
    ...
    #         [data] = self.conn.get_operational(f"/org-openroadm-device:org-openroadm-device/interface[name='{or_val}']/name")
    ...
    async def test_otsi_explicit_provision(self):
        def test():
            ...
            # transponder_data = self.conn.get(
            #     "/goldstone-transponder:modules"
            # )
            # print("transponder_data === ", transponder_data)       
            # self.conn.delete(
            #     "/goldstone-transponder:modules/module[name='piu1']/network-interface[name='0']"
            # )
            # self.conn.apply()
            # print("6666666666666", self.conn.get("/goldstone-transponder:modules/module[name='piu1']/network-interface[name='0']"))
            # test deletion
            otsi_data = self.conn.get(
                "/org-openroadm-device:org-openroadm-device/interface[name='otsi-piu1']"
            )
            print("otsi_data === ", otsi_data)
            # circuitpack_data = self.conn.get(
            #     "/org-openroadm-device:org-openroadm-device/circuit-packs[circuit-pack-name='piu1']"
            # )
            # print("circuitpack data === ", circuitpack_data)
            # circuitpack_data = self.conn.get_operational(
            #     "/org-openroadm-device:org-openroadm-device/circuit-packs[circuit-pack-name='piu1']"
            # )
            # print("circuitpack data operational === ", circuitpack_data)
            # interface_data = self.conn.get(
            #     f"/org-openroadm-device:org-openroadm-device/interface[name='otsi-piu1']"
            # )
            # print("interface data === ", interface_data)
            self.conn.delete(
                "/org-openroadm-device:org-openroadm-device/interface[name='otsi-piu1']"
            )
            # interface_data = self.conn.get_operational(
            #     f"/org-openroadm-device:org-openroadm-device/interface[name='otsi-piu1']"
            # )
            # print("interface data === ", interface_data)
